...
const MESSAGES = {
  ja: {
    brand: "DraftBox",
    tagline: "書く、数える、復元する。クラウド保存と共有まで一つの執筆机で。",
    language: "言語",
    title: "無題",
    counter: "文字数",
    signin: "サインイン",
    ...
    localMode: {
      title: "ローカル執筆モード",
      body: "クラウド保存はSupabase設定後に有効化。今は文字数、復元、エクスポートをすぐ使えます。",
    },
    share: {
    ...
    export: { md: ".mdで保存", html: ".htmlで保存", txt: ".txtで保存", filenameHint: "出力ファイル名の例：{name}.md" },
    stats: {
      title: "詳細カウント",
    ...
    studio: {
      ...
      title: "本文エディタ",
      snippets: "書式スニペット",
      snippetAdded: "{name} を追加しました。",
      focusOn: "集中",
      focusOff: "通常",
    },
    workbench: {
      title: "執筆ワークベンチ",
      subtitle: "次に直す場所と、失わない安心を常に横に置きます。",
      quality: "品質スコア",
      review: "レビュー",
      outline: "アウトライン",
      emptyOutline: "Markdown見出しを追加すると構成がここに表示されます。",
      keywords: "よく使う語",
      emptyKeywords: "本文を入力するとキーワードが表示されます。",
      units: { minutes: "分", chars: "字", pages: "枚" },
      goal: {
        type: "目標",
        target: "到達値",
        progress: "執筆目標の進捗",
      ...
      safety: {
        title: "ローカル復元",
        noAutosave: "この端末で自動バックアップを準備しています。",
        autosaved: "最終自動バックアップ: {time}",
        snapshot: "スナップショット保存",
        restoreAutosave: "自動保存を復元",
        restore: "復元",
        delete: "削除",
        restored: "ローカル保存から復元しました。",
  ...
  en: {
    brand: "DraftBox",
    tagline: "Write, count, recover, then save and share from one focused desk.",
    language: "Language",
    title: "Untitled",
    counter: "Characters",
    signin: "Sign in",
    ...
    localMode: {
      title: "Local writing mode",
      body: "Cloud save turns on after Supabase setup. Counting, recovery, and export work now.",
    },
    share: {
    ...
    studio: {
      ...
      snippetAdded: "Inserted {name}.",
      focusOn: "Focus",
      focusOff: "Normal",
    },
    workbench: {
      title: "Writing Workbench",
      subtitle: "Keep the next fix and recovery safety beside your draft.",
      quality: "Quality",
      review: "Review",
      outline: "Outline",
      emptyOutline: "Add Markdown headings to see the structure here.",
      keywords: "Frequent terms",
      emptyKeywords: "Keywords appear as you write.",
      units: { minutes: "m", chars: " chars", pages: "p" },
      goal: {
        type: "Goal",
        target: "Target",
        progress: "Writing goal progress",
        chars: "Characters",
        genko: "Genko pages",
      ...
      safety: {
        ...
        noAutosave: "Preparing an automatic backup on this device.",
        autosaved: "Last automatic backup: {time}",
        snapshot: "Save snapshot",
        restoreAutosave: "Restore autosave",
        restore: "Restore",
        delete: "Delete",
        restored: "Restored from local backup.",
