...
const MESSAGES = {
  ja: {
    ...
    workbench: {
      title: "執筆ワークベンチ",
      subtitle: "目標、読みやすさ、構成、復元をまとめて確認できます。",
      quality: "品質スコア",
      review: "レビュー",
      outline: "アウトライン",
  ...
  en: {
    ...
    studio: {
      ...
      plans: {
        free: "Free",
        freeCaption: "Writing + recovery",
        pro: "Pro",
        proCaption: "AI review + PDF later",
        team: "Team",
        teamCaption: "Collaboration later",
      },
    },
    workbench: {
      title: "Writing Workbench",
      subtitle: "Track goals, quality, structure, and recovery in one place.",
      quality: "Quality",
      review: "Review",
      outline: "Outline",
